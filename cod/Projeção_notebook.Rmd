---
title: "CÓDIGO DE PROJEÇÃO POPULACIONAL UFRN"
autor: 'Freire, F. H. M. de A., Gonzaga, M. R., & Gomes, M. M. F. (2020)'
output: html_notebook
---

#### Freire, F. H. M. de A., Gonzaga, M. R., & Gomes, M. M. F. (2020)

#### Funções de operacionalização do método de Duchesne

Função principla : projeção pelo método de duchesne automatizada para projetar todas as áreas menores por UF e fazer interpolação por ano calendário, salvando o resultado final no arquivo Projecoes_com_K_Bayesiano.csv
...
#### FUNÇÃO PARA CALCULAR PROJETAR A POPULAÇÃO POR SEXO E GRUPOS ETÁRIOS QUINQUENAIS ATÉ 90+ PELO MÉTODO DA RELAÇÃO INTERCENSITÁRIA DE SOBREVIVÊNCIA DE DUCHESNE.
...
##### INFORMAÇÕES IMPORTANTES SOBRE OS DADOS DE ENTRADA: 
   ...
   do Duchesne para 3 períodos à frente, "arma" terá 6 linhas (3 para mulheres e 3 para homens em seguida), cada uma com os valores da pop
   projetada para cada gr etário para a área maior para  cada um desses períodos. Essa projeção da área maior deve ter sido feita previamente ou obtida de alguma outra fonte de dados.
...
#### Função para compatibilização do tamanho da população da área maior projetada pelo somatório das áreas menores projetadas
...
#### 1.2 Função de cálculo dos fatores diferenciais de crescimento do método Duchesne para os grupos etário quinquenais intermediários (segundo ao penúltimo grupo etário)

  ESSA FUNÇÃO TEM COMO ENTRADA AS POP DE GRUPOS ETÁRIOS QUINQUENAIS ATÉ 95 e +.
  ...
  95+;Total2  # ESSA FUNÇÃO TEM COMO ENTRADA AS POP DE GRUPOS ETÁRIOS QUINQUENAIS ATÉ
  95 e +.
...
#### 1.3 Função de cálculo dos fatores diferenciais de crescimento do método Duchesne para o último grupo etário (grupo etário aberto em 90+)
...
Com isso se encerra os códigos comentados em notebook.R das projeções URFN
